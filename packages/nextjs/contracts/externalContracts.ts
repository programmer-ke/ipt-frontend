...
const externalContracts = {
  11155111: {
    RebaseToken: {
      address: "0x09b95a3ad294eb7b7692655731551d1d21da2f33",
      abi: [
    ...
    RebaseTokenPool: {
      address: "0x84ee785be7ada347d0874833dac50b8349afb554",
      abi: [
        {
          type: "constructor",
          inputs: [
        ...
        { type: "error", name: "OnlyCallableByOwner", inputs: [] },
        {
          ...
          inputs: [
            ...
            { name: "remoteAmount", type: "uint256", internalType: "uint256" },
          ],
        },
    ...
    Vault: {
      address: "0xf319f9c010c3c4a74a33a4fa09c6f3424666f7f3",
      abi: [
        {
          type: "constructor",
          inputs: [
        ...
        { type: "error", name: "Vault__MustBeGreaterThanZero", inputs: [] },
        { type: "error", name: "Vault__RedeemFailed", inputs: [] },
      ],
    },
  },
  84532: {
    RebaseToken: {
      address: "0x638d6b69f0e37f7ddd9ee1d63774d3619c968836",
      abi: [
        { type: "constructor", inputs: [], stateMutability: "nonpayable" },
        {
          type: "function",
    ...
    RebaseTokenPool: {
      address: "0x3408f221a2d2f3ceed0e2ce63a944b5a1b6f846c",
      abi: [
        {
          type: "constructor",
          inputs: [
